...
marmoset = {}; (function(marmoset) {
    ...
    fetchThumbnail = function(a, c, b, d) {
        ...
        g = function(a) { (a = (new Archive(a)).extract("thumbnail.jpg")) ? TextureCache.parseFile(a, c, d) : e ? b && b() : (e = !0, Network.fetchBinaryIncremental(f, g, b, 394240));
            return 0
        };
    ...
    function Fog(a, c) {
        ...
        b.push("#define FOG_SHADOWS");
        this.spotShaderShadow = a.shaderCache.fromURLs("fogvert.glsl", "fogfrag.glsl", b);
        b = ["#define FOG_OMNI"];
    ...
    Material.prototype.bind = function(a, c) {
        ...
        this.usesRefraction && (a.refractionSurface && a.refractionSurface.bind(s.tRefraction), d = Matrix.mul(Matrix.empty(), x, d.invMatrix), l.uniformMatrix4fv(p.uRefractionViewProjection, !1, d), l.uniform1f(p.uRefractionRayDistance, this.refractionParams.distantBackground ? 1E10: 4 * c.mesh.bounds.maxExtent), l.uniform3fv(p.uRefractionTint, this.refractionParams.tint), l.uniform1f(p.uRefractionAlbedoTint, this.refractionParams.useAlbedoTint ? 1 : 0), l.uniform1f(p.uRefractionIOREntry, 1 / this.refractionParams.IOR), (m = this.extrasTexCoordRanges.refractionMaskTex) && l.uniform4fv(p.uTexRangeRefraction, m));
                ...
                if (200 == e.status) {
                    ...
                    if (f && "none" != f) {
                        ...
                        h = function(b, e) {
                            ...
                            f.onload = function() { (206 == f.status || 200 == f.status) && c(f.response) && e < g && (b += d, e += d, e = e < g - 1 ? e: g - 1, h(b, e))
                            };
                            f.send()
                        };
                        h(0, d - 1)
    ...
    Scene.prototype.load = function(a) {
        ...
        // b.sky.backgroundColor = [232, 232, 232, 1];
        b.sky.backgroundColor = [189, 199, 205, 0];
    ...
    SceneAnimator.prototype.selectCamera = function(a) { - 1 != a && this.selectedCameraIndex != a && (this.selectedCameraIndex = a, this.setViewFromSelectedCamera())
    };
    ...
    UI.prototype.showPreview = function(a) {
        ...
        b.addColorStop(0, "rgb(255,255,255,1)");
        b.addColorStop(1, "rgb(255,255,255,1)");
        c.fillStyle = b;
    ...
    UI.prototype.setThumbnailURL = function(a) { (this.loadingImageURL = a) && Network.fetchImage(this.loadingImageURL, this.setThumbnail.bind(this))
    };
    ...
    UI.prototype.signalLoadProgress = function(a, c) {
        if (this.thumbnail) {
            if (!this.progressBar) {
                var b = document.createElement("div");
                // b.style.background = "rgb(0,0,0) url(images/loading.gif) no-repeat center center";
                b.style.background = "rgb(189, 199, 205, 1)";
                b.style.backgroundSize = "300px";
                if(window.screen.width<769){
                    b.style.backgroundSize = "600px"
                }
                b.style.opacity = 1;
                b.style.position = "absolute";
                b.style.left = "50%";
            ...
            // loading.innerText = this.progressBar.style.width;

            var progressBar = $('.progressBar div');
            var loadingPercent = $('.loading_percent');
            var width = this.progressBar.style.width;
            loadingPercent.text(width);
			progressBar.width(Math.round( parseFloat(width) / 100 * 220 ));
